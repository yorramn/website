...
const whatsappDestination = "https://wa.me/5513996694411";
const socialImageHead = `<meta property="og:image" content="https://yorramn.dev.br/assets/logoverde_1.jpg"><meta property="og:image:secure_url" content="https://yorramn.dev.br/assets/logoverde_1.jpg"><meta property="og:image:type" content="image/jpeg"><meta property="og:image:width" content="2202"><meta property="og:image:height" content="633"><meta property="og:image:alt" content="Yorramn Dev - Código que vira solução"><meta name="twitter:card" content="summary_large_image"><meta name="twitter:image" content="https://yorramn.dev.br/assets/logoverde_1.jpg">`;
const analyticsHead = `<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src='https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);})(window,document,'script','dataLayer','GTM-WXBP2PXV');</script><script async src="https://www.googletagmanager.com/gtag/js?id=G-7EYE9E4F6D"></script><script>window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments)}gtag('js',new Date());gtag('config','G-7EYE9E4F6D');</script>`;
...
const services = [
  ...
  },
  {
    ...
    title: "Desenvolvimento Web e Criação de Sites Profissionais",
    description: "Criação de landing pages de alta conversão, e-commerce (WordPress/WooCommerce) e portais corporativos sob medida. O braço técnico ágil que sua empresa ou agência precisa em todo o Brasil. Código limpo e otimizado para o Google e IAs.",
    eyebrow: "Desenvolvimento web para empresas e agências",
    headline: "Desenvolvimento web e criação de sites profissionais que geram resultados.",
    lead: "Crio landing pages, sites institucionais e e-commerces rápidos, responsivos e fáceis de gerenciar. Também atuo como parceiro técnico de agências que precisam transformar layouts em páginas fiéis, dentro do prazo.",
    intent: "Quero criar um site, landing page ou e-commerce.",
    situations: ["Sua empresa precisa de um site rápido que gere contatos e vendas", "Você investe em anúncios, mas a página não converte", "Seu site é lento, desatualizado ou difícil de gerenciar", "Sua agência precisa absorver demandas sem aumentar a equipe fixa"],
    audiences: [
      {
        title: "Para empresas e negócios tradicionais",
        text: "Uma presença digital rápida, responsiva e simples de administrar, construída para transformar visitas em oportunidades reais.",
        benefits: ["Site institucional e landing pages que geram leads", "E-commerce com WordPress, WooCommerce e meios de pagamento", "Painel amigável para atualizar produtos e conteúdos", "Performance, SEO e boa experiência no celular"]
      },
      {
        title: "Para agências de marketing",
        text: "Um parceiro técnico sênior para eliminar o gargalo de desenvolvimento e entregar com previsibilidade, sem competir com o relacionamento da agência.",
        benefits: ["Implementação fiel ao Figma com atenção Pixel Perfect", "Cumprimento de prazos e comunicação direta", "Apoio em demandas de transbordo e projetos white-label", "Código limpo, responsivo e pronto para publicação"]
      }
    ],
    deliverables: [
...
const footer = () => `<footer class="footer"><div class="container footer-grid"><a class="brand" href="/"><img src="/assets/logobranco.png" alt="Yorramn Dev" width="230" height="66"></a><p>Engenharia de software e consultoria tecnológica.<br>Código que vira solução.</p><div class="social-links"><a href="https://github.com/yorramn" target="_blank" rel="noopener noreferrer">${icons.github}GitHub</a><a href="mailto:yorramn.dev@gmail.com">${icons.mail}yorramn.dev@gmail.com</a><a href="tel:+5513996694411">${icons.phone}+55 (13) 99669-4411</a></div></div><div class="container footer-bottom"><span>&copy; 2026 Yorramn | Engenharia de Software. Atendimento 100% remoto para empresas e agências de todo o Brasil.</span></div></footer>`;
...
const baseHead = ({ title, description, path, schema }) => `<!doctype html><html lang="pt-BR"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>${title} | Yorramn</title><meta name="description" content="${description}"><meta name="robots" content="index, follow"><meta name="theme-color" content="#171225"><link rel="canonical" href="https://yorramn.dev.br${path}"><link rel="icon" type="image/png" href="/assets/favicon.png"><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@400;500;600;700&family=Sora:wght@400;500;600;700;800&display=swap" rel="stylesheet"><link rel="stylesheet" href="/styles.css"><link rel="stylesheet" href="/styles-overrides.css"><link rel="stylesheet" href="/pages.css"><meta property="og:type" content="website"><meta property="og:locale" content="pt_BR"><meta property="og:url" content="https://yorramn.dev.br${path}"><meta property="og:title" content="${title} | Yorramn"><meta property="og:description" content="${description}">${socialImageHead}<script type="application/ld+json">${JSON.stringify(schema)}</script>${analyticsHead}</head>`;

const audienceSection = (service) => service.audiences ? `<section class="page-section audience-section"><div class="container"><div class="page-heading"><p class="eyebrow">Uma parceria para cada cenário</p><h2>Desenvolvimento web que entende o seu negócio</h2><p>Atendimento remoto para empresas e agências de todo o Brasil, com clareza do início à entrega.</p></div><div class="audience-grid">${service.audiences.map(({ title, text, benefits }) => `<article><h3>${title}</h3><p>${text}</p><ul>${benefits.map((benefit) => `<li>${benefit}</li>`).join("")}</ul></article>`).join("")}</div></div></section>` : "";
...
function successPage() {
  ...
  return `<!doctype html><html lang="pt-BR"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>${title} | Yorramn</title><meta name="description" content="${description}"><meta name="robots" content="noindex, nofollow"><meta name="theme-color" content="#171225"><link rel="canonical" href="https://yorramn.dev.br${path}"><link rel="icon" type="image/png" href="/assets/favicon.png"><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@400;500;600;700&family=Sora:wght@400;500;600;700;800&display=swap" rel="stylesheet"><link rel="stylesheet" href="/styles.css"><link rel="stylesheet" href="/styles-overrides.css"><link rel="stylesheet" href="/pages.css"><meta property="og:type" content="website"><meta property="og:locale" content="pt_BR"><meta property="og:url" content="https://yorramn.dev.br${path}"><meta property="og:title" content="${title} | Yorramn"><meta property="og:description" content="${description}"><meta property="og:image" content="https://yorramn.dev.br/assets/logo-principal.png">${analyticsHead}</head><body class="success-page"><main class="success-shell"><section class="success-card" aria-labelledby="success-title"><a href="/" class="success-brand" aria-label="Yorramn Dev, início"><img src="/assets/logobranco.png" alt="Yorramn Dev" width="230" height="66"></a><span class="success-icon" aria-hidden="true">✓</span><p class="eyebrow">Mensagem enviada</p><h1 id="success-title">Solicitação Recebida com Sucesso!</h1><p>Obrigado pelo contato. Em breve entrarei em contato para conversarmos sobre o seu projeto.</p><a class="button" href="/">Voltar para a Home <span aria-hidden="true">→</span></a></section></main><footer class="success-footer">&copy; 2026 Yorramn | Engenharia de Software. Atendimento 100% remoto para empresas e agências de todo o Brasil.</footer></body></html>`;
}

function whatsappRedirectPage() {
  const path = "/whatsapp";
  return `<!doctype html><html lang="pt-BR"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Redirecionando para o WhatsApp | Yorramn Dev</title><meta name="description" content="Redirecionamento para o atendimento da Yorramn Dev pelo WhatsApp."><meta name="robots" content="noindex, nofollow"><meta name="theme-color" content="#171225"><link rel="canonical" href="https://yorramn.dev.br${path}"><link rel="icon" type="image/png" href="/assets/favicon.png"><meta http-equiv="refresh" content="0;url=${whatsappDestination}"><link rel="stylesheet" href="/styles.css"><link rel="stylesheet" href="/pages.css"></head><body class="redirect-page"><main><h1>Redirecionando para o WhatsApp</h1><p>Se o redirecionamento não acontecer, <a href="${whatsappDestination}">clique aqui para iniciar a conversa</a>.</p></main><footer class="success-footer">&copy; 2026 Yorramn | Engenharia de Software. Atendimento 100% remoto para empresas e agências de todo o Brasil.</footer><script>window.location.replace(${JSON.stringify(whatsappDestination)});</script></body></html>`;
}

function withSocialImage(html) {
  const imageMetaPattern = /<meta (?:(?:property="og:image(?::(?:secure_url|type|width|height|alt))?")|(?:name="twitter:(?:card|image)"))[^>]*>/g;
  return html.replace(imageMetaPattern, "").replace("</head>", `${socialImageHead}</head>`);
}

function generatedPages() {
  const pages = new Map(services.map((service) => [`servicos/${service.slug}/index.html`, withSocialImage(servicePage(service))]));
  pages.set("contato/index.html", withSocialImage(contactPage()));
  pages.set("solicitacao-recebida/index.html", withSocialImage(successPage()));
  pages.set("whatsapp/index.html", withSocialImage(whatsappRedirectPage()));
  return pages;
}
